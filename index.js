const apiKey = 'b91d122883483d471bea5bde4b4ad7f3';
...
function fetchWeatherData(location) {
    ...
    fetch(apiUrl).then(response => response.json()).then(data => {
        ...
        todayWeatherIcon.className = `bx bx-${weatherIconMap[todayWeatherIcon]}`;
        ...
        const nexDaysData = data.list.slice(1);

        const uniqueDays = new Set();
        let count = 9;
        daysList.innerHTML ='';
        for (const dayData of nexDaysData){
